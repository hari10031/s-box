...
import { createCustomer } from '../../api/users';
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <FormInput label="Full Name" value={form.name} onChangeText={v => update('name', v)} placeholder="Customer name" />
        ...
        <Button title="Create Customer" onPress={handleCreate} loading={loading} style={{ marginTop: 8 }} />
      </ScrollView>
    </View>
  );
}
